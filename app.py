...
def predict_maternal_risk():
    ...
    return {"predicted_risk": predicted_risk}
...
def predict_gdm():
    ...
    new_data_point = pd.DataFrame({
        "BMI": [data["BMI"]],
        "HDL": [data["HDL"]],
        "Sys BP": [data["SystolicBP"]],
        "Dia BP": [data["DiastolicBP"]],
    ...
    return {"prediction": int(prediction[0])}  # Assuming 0 for Non GDM and 1 for GDM
...
def predict_hyperthyroid():
    ...
    return {"predicted_target": predicted_target_str}
